...
{
    /// <summary>
    /// COM interface for WebView2Parser class.
    /// </summary> 
    ...
    /// <summary>
    /// Provides methods for parsing, manipulating, and serializing JSON data.
    /// Standardized name for v2.0.
    /// </summary>
    [Guid("5C2E3D4F-A5B6-7C8D-9E0F-1A2B3C4D5E6F")]
    [ComVisible(true)]
    [ProgId("NetWebView2Lib.WebView2Parser")]
    [ClassInterface(ClassInterfaceType.None)]
    public class WebView2Parser : IJsonParser
    {
    ...
    /// <summary>
    /// Compatibility Layer for JsonParser (Legacy name).
    /// Inherits all functionality from WebView2Parser.
    /// </summary>
    [Guid("C5D6E7F8-A9B0-4C1D-8E2F-3A4B5C6D7E8F")] // OLD GUID
    [ComVisible(true)]
    [ProgId("NetJson.Parser")] // OLD ProgID
    [ClassInterface(ClassInterfaceType.None)]
    public class JsonParser : WebView2Parser, IJsonParser
    {
        // No additional code needed, inherits everything.
    }
}